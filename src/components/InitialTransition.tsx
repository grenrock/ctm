...
export const InitialTransition: React.FC<InitialTransitionProps> = ({
  ...
  return (
    <motion.div
      className="absolute z-50 flex items-center justify-center text-center w-full h-full ctm-bg"
      initial="initial"
      animate="animate"
    ...
    >
      <motion.div
        ...
        className="absolute z-50 flex -mt-12"
      >
        <motion.div
      ...
      >
        <motion.div
          variants={textAnimation}
          className="text-4l font-bold ctm-nav-link"
        >
          Welcome to our team!
        </motion.div>
      </motion.div>
